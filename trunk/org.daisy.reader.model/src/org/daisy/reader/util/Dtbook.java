...
public class Dtbook {
	 ...
	 * @throws IOException
	 */		
	public static File htmlize(URL source, File dest, boolean modifyRelativeLinks) throws IOException, XMLStreamException, URISyntaxException {
				...
				switch(reader.getEventType()) {
					...
					case XMLStreamConstants.START_ELEMENT:
						...
						if(reader.getName().getLocalPart().equals(HEAD)) {
							...
							writer.writeAttribute(HTTP_EQUIV, CONTENT_TYPE);
							writer.writeAttribute(CONTENT, "application/xhtml+xml; charset=utf-8"); //$NON-NLS-1$							
						}						
						break;
	...
	public static File htmlize(URL source, File dest) throws IOException, XMLStreamException, URISyntaxException {
	...
	private static final String META = "meta"; //$NON-NLS-1$
	...
	private static final String HTTP_EQUIV = "http-equiv"; //$NON-NLS-1$
